...
const Plane = () => {
    ...
    return (
        <div>
            <div data-aos="fade-up-left" data-aos-duration="3000" className="pl-4 mt-10 ">
            ...
            <div data-aos="fade-up-right" data-aos-duration="3000" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
                {
